...
class ReportSInv //extends JFrame //implements ActionListener ,Printable
{
	/*
	...
	*/
	...
	ReportSInv(String orinfo[],String Pname[],String PP[],String PQ[],String PQD[])
	{
		...
		*/
		...
		try {
			...
			String t1 = " ";
			String text2 = "  Sales Invoice Details from date "+ner[0]+" to date "+ner[1]+" ";
			...
			int headerwidths[] = { 15, 12, 12, 12 }; // percentage
		...
		try
		{
			...
			Process p;
			String path[]={"Foxit Reader.exe","SInv.pdf"};
			p=r.exec(path);
		}
		catch(IOException ioe)
		{
	...
	public static void main(String[] args) 
	{
		...
		String[] d= {"10","6","9","22"};
		ReportSInv r=new ReportSInv(x,y,z,a,b);
