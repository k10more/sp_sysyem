...
import javax.swing.table.*;
 ...
 class ecust extends JFrame implements ActionListener 
{
	...
	JLabel l1=new JLabel("Existing Customer Details  ");
	...
	public ecust()
	{	
		super("Existing Customer Details");
		...
		try
		{
			...
			rs5=st5.executeQuery("select Cust_Id,Cust_Name,Del_Add,Cont_No from customer where Cust_Status= 0 ");
			...
			rs1=st1.executeQuery("select Cust_Id,Cust_Name,Del_Add,Cont_No from customer where Cust_Status=0");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==print)
		{
			...
			Reportecust r=new Reportecust(ner,cid,cnm,cdl,cno,l);
