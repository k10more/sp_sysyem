...
class  Reporteprod extends JFrame //implements ActionListener ,Printable
{
	/*
	...
	*/
	...
	String[] col = { "Product Id", "Product Name", "Description", "Purchase Price","Sales Price"};
	int NumColumns = 5;
	...
	Reporteprod(String orinfo[],String Pname[],String PP[],String PQ[],String PQD[],String SQD[],int c)
	{
		cnt=c;
		...
		try {
			PdfWriter.getInstance(document,
					new FileOutputStream("eprod.pdf"));
			...
			datatable.addCell("Purchase Price");
			datatable.addCell("Sales Price");
			...
			*/
			...
			for (int i = 0; i < cnt; i++) {
				if (i % 2 == 1) {
					...
					datatable.addCell(pid[i]);
					datatable.addCell(pnm[i]);
					datatable.addCell(pdl[i]);
					datatable.addCell(pp[i]);
					datatable.addCell(sp[i]);
		...
		try
		{
			...
			Process p;
			String path[]={"Foxit Reader.exe","eprod.pdf"};
			p=r.exec(path);
		}
		catch(IOException ioe)
		{
	...
	public static void main(String[] args) 
	{
		...
		String[] y= {"p1","p2","p3","p4","p5"};
		String[] z= {"COCA COLA 300ML","THUMS UP 300ML","SPRITE 500ML","COCA COLA 500ML","THUMS UP 500ML"};
		String[] a= {"MAIN PRODUCT","FAMOUS IN YOUNG STUDENT","SWEET SODA","PREFERED BY DRINKING","CHOICE OF ELDERS"};
		String[] b= {"8","8","16","15","15"};
		String[] c= {"10","10","18","18","18"};
		//String[] d= {"","6","9","22"};
		Reporteprod r=new Reporteprod(x,y,z,a,b,c,4);
