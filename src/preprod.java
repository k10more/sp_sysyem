...
import javax.swing.table.*;
 ...
 class preprod extends JFrame implements ActionListener 
{
	...
	JLabel l1=new JLabel("Previous Products Details  ");
	...
	public preprod()
	{	
		super("Previous Products Details");
		...
		try
		{
			...
			rs5=st5.executeQuery("select Pro_Id,Pro_Name,Discr,Cost_Price,Sales_Price from Product where Pro_Status= 1 ");
			...
			rs1=st1.executeQuery("select Pro_Id,Pro_Name,Discr,Cost_Price,Sales_Price from Product where Pro_Status= 1 ");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==print)
		{
			...
			Reportpreprod r=new Reportpreprod(ner,pid,pnm,pdl,pp,sp,l);
