...
import javax.swing.table.*;
 ...
 class presup extends JFrame implements ActionListener 
{
	...
	JLabel l1=new JLabel("Previous Supplier Details  ");
	...
	public presup()
	{	
		super(" Previous Suppliers Details");
		...
		try
		{
			...
			rs5=st5.executeQuery("select Supl_Id,Supl_Name,Off_Add,Cont_No from supplier where Supl_Status= 1 ");
			...
			rs1=st1.executeQuery("select Supl_Id,Supl_Name,Off_Add,Cont_No from supplier where Supl_Status= 1");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==print)
		{
			...
			Reportesup r=new Reportesup(ner,cid,cnm,cdl,cno,l);
