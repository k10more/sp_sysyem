...
class  Reportecust extends JFrame //implements ActionListener ,Printable
{
	/*
	...
	*/
	...
	Reportecust(String orinfo[],String Pname[],String PP[],String PQ[],String PQD[],int c)
	{
		cnt=c;
		...
		try {
			PdfWriter.getInstance(document,
					new FileOutputStream("ecust.pdf"));
			...
			String t1 = " ";
			String text2 = "  Existing Customers Details from date  "+ner[0]+" to date "+ner[1]+" ";
		...
		try
		{
			...
			Process p;
			String path[]={"Foxit Reader.exe","ecust.pdf"};
			p=r.exec(path);
		}
		catch(IOException ioe)
		{
