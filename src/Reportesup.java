...
class  Reportesup extends JFrame //implements ActionListener ,Printable
{
	/*
	...
	*/
	...
	Reportesup(String orinfo[],String Pname[],String PP[],String PQ[],String PQD[],int c)
	{
		cnt=c;
		...
		try
		{
			...
			Process p;
			String path[]={"Foxit Reader.exe","esup.pdf"};
			p=r.exec(path);
		}
		catch(IOException ioe)
		{
	...
	public static void main(String[] args) 
	{
		...
		//String[] d= {"10","6","9","22"};
		Reportesup r=new Reportesup(x,y,z,a,b,4);
