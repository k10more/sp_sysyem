...
class  Reportpreprod extends JFrame //implements ActionListener ,Printable
{
	/*
	...
	*/
	...
	Reportpreprod(String orinfo[],String Pname[],String PP[],String PQ[],String PQD[],String SQD[],int c)
	{
		cnt=c;
		...
		try {
			PdfWriter.getInstance(document,
					new FileOutputStream("Preprod.pdf"));
		...
		try
		{
			...
			Process p;
			String path[]={"Foxit Reader.exe","Preprod.pdf"};
			p=r.exec(path);
		}
		catch(IOException ioe)
		{
	...
	public static void main(String[] args) 
	{
		...
		String[] c= {"","","",""};
		//String[] d= {"10","6","9","22"};
		Reportpreprod r=new Reportpreprod(x,y,z,a,b,c,4);
