...
class ReportPInv //extends JFrame //implements ActionListener ,Printable
{
	/*
	...
	*/
	...
	String[] col = { "Product Name", "Price", "Qty Invoiced","Qty Return"};
	int NumColumns = 4;
	...
	ReportPInv(String orinfo[],String Pname[],String PP[],String PQ[],String PQD[])
	{
		...
		*/
		...
		try {
			...
			String t1 = " ";
			String text2 = "  Purchase Invoice Details from date "+ner[0]+" to date "+ner[1]+" ";
			String text3 = "    Invoice No.: "+ner[2]+"                   Invoice Date : "+ner[3]+" ";
			String text4 = "    Supplier Name : "+ner[4]+"              Status : "+ner[5]+" ";
			String text9 = "    Order No : "+ner[8]+"";
			//String text5 = "    Dispatched Amount : "+ner[7]+"          Returned Amount : "+ner[9]+" ";
			String text6 = "    Returned Amount : "+ner[7]+"             Total Amount : "+ner[6]+" ";
			String text7 = "________________________________________________________________________";
			String text8 ="Date : "+date+" ";;
			PdfPTable datatable = new PdfPTable(NumColumns);
			int headerwidths[] = { 10, 15, 15, 10}; // percentage
			...
			datatable.addCell("Qty Invoiced");
			datatable.addCell("Qty Returned");
			...
			document.add(new Paragraph(t1, font));
			font = new Font(bfComic, 12,1);
			document.add(new Paragraph(text9, font));
			font = new Font(bfComic, 9);
			document.add(new Paragraph(t1, font));
			document.add(new Paragraph(t1, font));
			font = new Font(bfComic, 12,1);
		...
		try
		{
			...
			Process p;
			String path[]={"Foxit Reader.exe","PInv.pdf"};
			p=r.exec(path);
		}
		catch(IOException ioe)
		{
	...
	public static void main(String[] args) 
	{
		...
		String[] d= {"10","6","9","22"};
		ReportPInv r=new ReportPInv(x,y,z,a,b);
