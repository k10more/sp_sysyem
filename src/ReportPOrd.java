...
class  ReportPOrd extends JFrame //implements ActionListener ,Printable
{
	/*
	...
	*/
	...
	ReportPOrd(String orinfo[],String Pname[],String PP[],String PQ[],String PQD[],String PQP[],String PQR[])
	{
		...
		try {
			...
			PdfWriter.getInstance(document,
					new FileOutputStream("POrder.pdf"));
			...
			String t1 = " ";
			String text2 = "  Purchase Order Details from date "+ner[0]+" to date "+ner[1]+" ";
			...
			int headerwidths[] = { 15, 5, 7, 8, 8, 6 }; // percentage
		...
		try
		{
			...
			Process p;
			String path[]={"Foxit Reader.exe","POrder.pdf"};
			p=r.exec(path);
		}
		catch(IOException ioe)
		{
	...
	public static void main(String[] args) 
	{
		...
		String[] d= {"10","6","9","22"};
		ReportPOrd r=new ReportPOrd(x,y,z,a,b,c,d);
