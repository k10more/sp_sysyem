...
import javax.swing.table.*;
 ...
 class esup extends JFrame implements ActionListener 
{
	...
	JLabel l1=new JLabel("Existing Supplier Details  ");
	...
	public esup()
	{	
		super(" Existing Suppliers Details");
		...
		try
		{
			...
			rs5=st5.executeQuery("select Supl_Id,Supl_Name,Off_Add,Cont_No from supplier where Supl_Status= 0 ");
			...
			rs1=st1.executeQuery("select Supl_Id,Supl_Name,Off_Add,Cont_No from supplier where Supl_Status= 0");
